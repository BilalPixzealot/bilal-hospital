<?php $__env->startSection('title', 'Gallery – Bilal Hospital Mumbra'); ?>
<?php $__env->startSection('meta_description', 'View photos of Bilal Hospital facilities including ICU, Operation Theatre, Wards, NICU and more.'); ?>
...
<section class="py-24" style="background:#F7F9FC;">
    <div class="max-w-7xl mx-auto px-5">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;margin-bottom:40px;" data-aos="fade-up">
            ...
            <a href="<?php echo e(route('gallery', ['category' => $cat])); ?>"
                ...
                <?php echo e($activeCategory === $cat ? 'background:#1B3A7A;color:#fff;' : 'background:#fff;color:#1B3A7A;border:2px solid #e5e7eb;'); ?>">
                <?php echo e($cat); ?>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4" id="gallery-grid">
            ...
            <div style="overflow:hidden;border-radius:10px;cursor:pointer;position:relative;box-shadow:0 2px 12px rgba(0,0,0,0.08);"
                 data-aos="fade-up" data-aos-delay="<?php echo e(($loop->index % 4) * 50); ?>"
                 onclick="openLightbox('<?php echo e(asset('storage/' . $img->image)); ?>', '<?php echo e($img->title ?? ''); ?>')">
                <img src="<?php echo e(asset('storage/' . $img->image)); ?>"
                     alt="<?php echo e($img->title ?? 'Hospital Gallery'); ?>"
                ...
                <div style="position:absolute;bottom:0;left:0;right:0;background:linear-gradient(transparent,rgba(18,37,80,0.85));padding:20px 12px 10px;pointer-events:none;">
                    <p style="font-family:Montserrat;font-weight:600;font-size:12px;color:#fff;"><?php echo e($img->title); ?></p>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\htdocs\projects\bilal\New folder\New folder\bilal-hospital\bilal-hospital-website\resources\views/pages/gallery.blade.php ENDPATH**/ ?>
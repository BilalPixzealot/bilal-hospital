...
<body class="bg-gray-50 font-[Inter] min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md px-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8">
            <?php if($errors->any()): ?>
            <div class="bg-red-50 border border-red-200 text-red-700 rounded-lg p-4 mb-6 text-sm"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" required value="<?php echo e(old('email')); ?>" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary" placeholder="admin@bilal-hospital.com">
                </div>
                <div>
        ...
        <div class="text-center mt-6">
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 hover:text-primary"><i class="fas fa-arrow-left mr-1"></i>Back to Website</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\projects\htdocs\projects\bilal\New folder\New folder\bilal-hospital\bilal-hospital-website\resources\views/auth/login.blade.php ENDPATH**/ ?>
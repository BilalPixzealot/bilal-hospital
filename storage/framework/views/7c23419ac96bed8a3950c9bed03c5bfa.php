...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Bilal Hospital'); ?> | Multispecialty Hospital, Mumbra</title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Bilal Hospital is a 50-bedded multispecialty hospital in Mumbra, Thane with well-equipped ICU, NICU, OT and diagnostic centre.'); ?>">
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Bilal Hospital'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Bilal Hospital - Multispecialty Hospital in Mumbra, Thane'); ?>">
...
<header id="main-header" class="site-header fixed top-0 left-0 right-0 z-50 bg-transparent">
    <div class="max-w-7xl mx-auto px-5">
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden lg:flex items-center gap-1">
                <a href="<?php echo e(route('home')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('home') ? 'text-orange-300' : ''); ?>">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('about') ? 'text-orange-300' : ''); ?>">About</a>

                
                <div class="nav-item relative">
                    <a href="<?php echo e(route('departments')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors flex items-center gap-1 <?php echo e(request()->routeIs('departments*') ? 'text-orange-300' : ''); ?>">
                    ...
                    <div class="nav-dropdown absolute top-full left-0 w-64 bg-white shadow-2xl rounded-lg py-2 z-50 max-h-96 overflow-y-auto">
                        <?php $navDepts = \App\Models\Department::where('is_active', true)->orderBy('sort_order')->get(['name','slug']) ?>
                        <?php $__currentLoopData = $navDepts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('departments.show', $dept->slug)); ?>" class="block px-4 py-2 text-[13px] text-gray-700 font-sans hover:bg-primary hover:text-white transition-colors"><?php echo e($dept->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>

                <a href="<?php echo e(route('doctors')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('doctors*') ? 'text-orange-300' : ''); ?>">Doctors</a>
                <a href="<?php echo e(route('cashless')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('cashless') ? 'text-orange-300' : ''); ?>">Cashless</a>
                <a href="<?php echo e(route('gallery')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('gallery') ? 'text-orange-300' : ''); ?>">Gallery</a>
                <a href="<?php echo e(route('contact')); ?>" class="nav-link text-white hover:text-orange-300 px-3 py-2 text-[13px] font-heading font-semibold tracking-wide transition-colors <?php echo e(request()->routeIs('contact') ? 'text-orange-300' : ''); ?>">Contact</a>
                <a href="<?php echo e(route('appointment')); ?>" class="ml-3 btn-primary py-[10px] px-6 text-[12px]">
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-primary-dark border-t border-blue-800">
        <div class="max-w-7xl mx-auto px-5 py-4 flex flex-col gap-1">
            <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Home</a>
            <a href="<?php echo e(route('about')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">About</a>
            <a href="<?php echo e(route('departments')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Departments</a>
            <a href="<?php echo e(route('doctors')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Our Doctors</a>
            <a href="<?php echo e(route('cashless')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Cashless Facility</a>
            <a href="<?php echo e(route('gallery')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Gallery</a>
            <a href="<?php echo e(route('blog')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Health Blog</a>
            <a href="<?php echo e(route('contact')); ?>" class="text-white hover:text-orange-300 py-2 text-[13px] font-heading font-semibold">Contact</a>
            <a href="<?php echo e(route('appointment')); ?>" class="btn-primary mt-2 text-center justify-center">Book Appointment</a>
        </div>
    </div>
</header>
    ...
    <div class="max-w-7xl mx-auto px-5">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <?php $__currentLoopData = [['home','Home'],['about','About Us'],['departments','Departments'],['doctors','Our Doctors'],['cashless','Cashless Facility'],['gallery','Gallery'],['blog','Health Blog'],['contact','Contact Us']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$r,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route($r)); ?>" class="text-gray-400 hover:text-accent text-[13px] transition-colors flex items-center gap-2"><i class="fas fa-angle-right text-accent text-xs"></i><?php echo e($label); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="w-8 h-0.5 bg-accent mb-4"></div>
                <ul class="space-y-2">
                    <?php $__currentLoopData = [['icu-general-medicine','ICU & General Medicine'],['maternity-obstetrics','Maternity & Obstetrics'],['gynaecology','Gynaecology'],['nicu','NICU'],['orthopedic-surgery','Orthopedics'],['neuro-surgery','Neuro Surgery'],['diagnostic-centre','Diagnostic Centre'],['accident-burn-trauma-care','Emergency Care']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$slug,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(route('departments.show',$slug)); ?>" class="text-gray-400 hover:text-accent text-[13px] transition-colors flex items-center gap-2"><i class="fas fa-angle-right text-accent text-xs"></i><?php echo e($label); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
        ...
        <div class="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
            <p class="text-gray-500 text-[12px]">&copy; <?php echo e(date('Y')); ?> Bilal Hospital. All Rights Reserved. | Mumbra, Thane, Maharashtra</p>
            <div class="flex gap-5 text-[12px] text-gray-500">
                ...
                <a href="<?php echo e(route('sitemap')); ?>" class="hover:text-accent transition-colors">Sitemap</a>
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH D:\projects\htdocs\projects\bilal\New folder\New folder\bilal-hospital\bilal-hospital-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>